...
mysqldump -h127.0.0.1 -uinspurCloudDB -pincloudosInspur2! --databases cloudos_db --tables t_rs_resource_template >> ${s1}${s2}${s3} --single-transaction
mysqldump -h127.0.0.1 -uinspurCloudDB -pincloudosInspur2! --databases cloudos_db --tables t_rs_resource_template_history >> ${s1}${s2}${s3} --single-transaction
